...
BIOME_SCOPE ?= skills/adr/scripts/adr.ts __tests__/adr-script.test.ts package.json tsconfig.json biome.json knip.json vitest.config.unit.ts vitest.config.integration.ts vitest.config.llm.ts
JSCPD_SCOPE ?= skills/adr/scripts/adr.ts
